    ...
    <div>
      <main className="flex flex-col md:flex-row">
        ...
        <section className="w-full md:w-[80%] min-h-screen">
          <article className=" md:ml-0 px-2 md:px-10">
            <h1 className=" font-bold text-3xl my-5 mt-20 md:0">Resume Builder</h1>
              ...
              <form className="w-full md:w-[40%] border-r border-[#565D6DFF] min-h-screen flex flex-col gap-6 pb-10">
                <fieldset>
                  ...
                  {["fullName", "email", "phone", "address", "linkedin", "github"].map(field => (
                    <div key={field} className="flex flex-col mt-5 w-full md:w-[90%]">
                ...
                <fieldset>
                  ...
                  <textarea
                    className="border border-[#565D6DFF] pl-3 pt-2 rounded-sm w-full md:w-[90%]"
                    rows={4}
                ...
                <fieldset>
                  ...
                  <input
                    ...
                    className="border border-[#565D6DFF] pl-3 h-10 rounded-sm w-full md:w-[90%]"
                    value={form.skills}
                ...
                <fieldset>
                  ...
                  {form.workExperience.map((we, i) => (
                    <div key={i} className="flex flex-col gap-2 mt-3 w-full md:w-[90%] border p-3 rounded">
                      ...
                      <div>
                        <input type="text" placeholder="Start Date" className="border pl-2 w-full mb-2 h-10 rounded-sm" value={we.startDate} onChange={e => handleWorkChange(i, "startDate", e.target.value)} />
                        <input type="text" placeholder="End Date" className="border pl-2 h-10 w-full rounded-sm" value={we.endDate} onChange={e => handleWorkChange(i, "endDate", e.target.value)} />
                      </div>
                ...
                <fieldset>
                  ...
                  <button type="button" className="mt-3 text-blue-600 underline md:w-[90%]" onClick={addReference}>+ Add Reference</button>
                </fieldset>

                <button
                  type="button"
                  className="mt-5 bg-blue-500 text-white w-full md:w-[90%] h-12 rounded"
